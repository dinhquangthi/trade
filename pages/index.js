...
export default {
  ...
  computed: {
    caculated() {
      ...
      let win, lose, roe;
      const vol = this.editedItem.volume;
      const entry = this.editedItem.entry;
      const tp = this.editedItem.take_profit;
      const sl = this.editedItem.stop_loss;
      const market = this.editedItem.market;
      const position = this.editedItem.position;
